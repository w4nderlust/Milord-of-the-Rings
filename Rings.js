	...
	d3.csv('continent_data/olympics_with_continents.csv',function(data){
			...
			*/
			...
			var getGDP = function(d){
				var GDP = {'Africa':1638404000000, 'Asia':12084604000000, 'Europe':18806370000000, 'Americas':17587792000000+3535527000000, 'Oceania':1392028000000};
			...
			*/
			...
			/* Translation for each ring 	*/
				var translations = {Europe:[-outRadius*2 + xpos, -ypos], Asia:[-outRadius + xpos, -ypos+outRadius], Africa:[+ xpos, -ypos], Americas:[outRadius + xpos, -ypos+outRadius], Oceania:[outRadius*2 + xpos, -ypos]}
			...
			*/
			...
			MakeCircle('Males',(6*outRadius + 1.5*circleDistance),25);
			MakeCircle('Total',(3*outRadius + 1.5*circleDistance),250);
			MakeCircle('Gold',(outRadius + 0.5*circleDistance),250);
			MakeCircle('Silver',-(outRadius + 0.5*circleDistance),250);
			MakeCircle('Bronze',-(3*outRadius + 1.5*circleDistance),250);
			MakeCircle('Athletes',(6*outRadius + 1.5*circleDistance),-100);
			MakeCircle('Females',(6*outRadius + 1.5*circleDistance),150);
			MakeCircle('People',-(6*outRadius + 1.5*circleDistance),-100);
			MakeCircle('GDP',-(6*outRadius + 1.5*circleDistance),150);
			MakeCircle('Countries', -(6*outRadius + 1.5*circleDistance),25);
			...
			*/
			...
			var explode_implode_ring = function (ring_id, translation) {
				...
				//var translation = medals_translation;
